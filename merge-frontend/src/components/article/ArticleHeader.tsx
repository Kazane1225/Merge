 ...
 */
export default function ArticleHeader({ article, translatedTitle }: ArticleHeaderProps) {
  ...
  return (
    <div className="mb-10">
      <span className={badgeClass}>{sourceBadge}</span>
      <h1 className="text-4xl lg:text-5xl font-bold text-slate-100 mb-4">{translatedTitle ?? article.title}</h1>
    </div>
  );
}

...
// article本文レンダリング用の長大なclassNameをここに定義
...
const ArticleContent = React.memo(function ArticleContent({ article, className }: ArticleContentProps) {
  ...
  return (
    <div ref={contentRef} onScroll={handleScroll} className={clsx('overflow-y-auto scroll-smooth relative w-full h-full', className)}>
      {/* スクロール進捗バー */}
